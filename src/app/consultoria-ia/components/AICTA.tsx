			...
			>
				<div className="steam-panel-strong rounded-3xl p-8 sm:p-12">
					...
					<h2 className="mt-6 text-2xl font-bold sm:text-3xl">
						Descubre qué IA encaja en tu <span className="text-gradient">negocio</span>
					</h2>
					<p className="mx-auto mt-4 max-w-lg text-base text-muted-foreground sm:text-lg">
						Agenda una primera consulta gratuita. Analizo tu caso y te digo honestamente si la IA tiene sentido para lo
						que necesitas.
					</p>
