			...
			>
				<div className="steam-panel-strong rounded-3xl p-8 sm:p-12">
					...
					<h2 className="mt-6 text-2xl font-bold sm:text-3xl">
						Construyamos tu próxima <span className="text-gradient">web</span>
					</h2>
					<p className="mx-auto mt-4 max-w-lg text-base text-muted-foreground sm:text-lg">
						Háblame de tu idea o negocio. Te respondo con una propuesta técnica, plazos estimados y presupuesto sin
						compromiso.
					</p>
