...
Crear un segundo agente ("lab" o "work") para probar multi-agente en producción. Explorar sandbox con Docker. Configurar bindings multi-cuenta. Probar comunicación cross-agent. Integrar con Codex app-server o Claude CLI como runtime alternativo.
