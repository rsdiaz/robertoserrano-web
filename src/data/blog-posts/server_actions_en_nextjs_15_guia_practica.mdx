...
image:
    url: 'https://res.cloudinary.com/rserrano/image/upload/v1777808824/blog-posts/ilustracion-de-server-actions-en-nextjs-15.png'
...
export async function actualizarPerfilUsuario(
    userId: string,
    nuevosDatos: { nombre: string; bio: string }
) {
